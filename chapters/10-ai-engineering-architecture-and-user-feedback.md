...
[Previous: Chapter 9 - Inference Optimization](09-inference-optimization.md) | [Back to Main Index](../README.md)
...
This step was covered in depth in [Chapter 6](06-rag-and-agents.md). The retrieval component typically includes a vector database, an embedding model and a retrieval strategy (dense, sparse or hybrid). The retrieved context is then formatted and prepended to the user query before being sent to the model.
