...
<div class="book-hero">
  ...
  <div class="book-hero__cover">
    <img src="assets/cover/book-cover.jpg" alt="AI Engineering Playbook cover" width="320" />
  </div>
</div>
...
<div class="book-grid">
  <div class="book-card">
    <h2>10 Chapters</h2>
    <p>From foundations and evaluation through RAG, finetuning, inference optimization, and production architecture.</p>
  </div>
  <div class="book-card">
    <h2>Figures + Diagrams</h2>
    <p>Visual explanations, Mermaid workflows, and embedded source figures preserved across the site.</p>
  </div>
  <div class="book-card">
    <h2>Built For Reading</h2>
    <p>Improved navigation, readable typography, and polished content blocks designed for long-form study.</p>
  </div>
</div>
...
|:-:|---------|--------------------------|:-------:|
| 01 | [**Introduction to Building AI Applications**](chapters/01-introduction/) | What is AI engineering, why does it matter now and what can you build with it? | 16 |
| 02 | [**Understanding Foundation Models**](chapters/02-understanding-foundation-models/) | How do foundation models work under the hood, and why do they behave the way they do? | 26 |
| 03 | [**Evaluation Methodology**](chapters/03-evaluation-methodology/) | How do you measure whether a model is actually good at what you need it to do? | 10 |
| 04 | [**Evaluate AI Systems**](chapters/04-evaluate-ai-systems/) | How do you build a reliable, systematic evaluation pipeline for your application? | 10 |
| 05 | [**Prompt Engineering**](chapters/05-prompt-engineering/) | How do you craft instructions that consistently get the model to do what you want? | 16 |
| 06 | [**RAG and Agents**](chapters/06-rag-and-agents/) | How do you give models access to external knowledge and the ability to take actions? | 16 |
| 07 | [**Finetuning**](chapters/07-finetuning/) | When and how should you change the model itself to improve performance? | 20 |
| 08 | [**Dataset Engineering**](chapters/08-dataset-engineering/) | How do you acquire, curate, synthesize and validate the data that powers your AI? | 7 |
| 09 | [**Inference Optimization**](chapters/09-inference-optimization/) | How do you make model inference faster and cheaper without sacrificing quality? | 19 |
| 10 | [**Architecture and User Feedback**](chapters/10-ai-engineering-architecture-and-user-feedback/) | How do you bring everything together into a production system that improves over time? | 21 |
...
|-------------------|------------|
| Understand what AI engineering is and plan your project | [Ch 1. Introduction](chapters/01-introduction/) |
| Learn how transformers, attention and sampling work | [Ch 2. Foundation Models](chapters/02-understanding-foundation-models/) |
| Set up metrics and benchmarks for model quality | [Ch 3. Evaluation Methodology](chapters/03-evaluation-methodology/) |
| Build a systematic evaluation pipeline for your app | [Ch 4. Evaluate AI Systems](chapters/04-evaluate-ai-systems/) |
| Write better prompts and defend against attacks | [Ch 5. Prompt Engineering](chapters/05-prompt-engineering/) |
| Add external knowledge or build AI agents | [Ch 6. RAG and Agents](chapters/06-rag-and-agents/) |
| Decide when and how to finetune a model | [Ch 7. Finetuning](chapters/07-finetuning/) |
| Curate, synthesize or clean training data | [Ch 8. Dataset Engineering](chapters/08-dataset-engineering/) |
| Make inference faster, cheaper or more efficient | [Ch 9. Inference Optimization](chapters/09-inference-optimization/) |
| Design production architecture with feedback loops | [Ch 10. Architecture and Feedback](chapters/10-ai-engineering-architecture-and-user-feedback/) |
