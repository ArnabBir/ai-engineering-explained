...
![Figure 7-1. The making of different Code Llama models](../assets/ch07/fig-7-1-code-llama-models.png){ width="700" }

<p class="figure-caption">Figure 7-1. The making of different Code Llama models</p>
...
![Figure 7-7. Partial finetuning requires many trainable parameters](../assets/ch07/fig-7-7-partial-finetuning.png){ width="700" }

<p class="figure-caption">Figure 7-7. Partial finetuning requires many trainable parameters</p>
...
![Figure 7-9. Hard and soft prompts combined to change model behavior](../assets/ch07/fig-7-9-hard-soft-prompts.png){ width="700" }

<p class="figure-caption">Figure 7-9. Hard and soft prompts combined to change model behavior</p>
...
![Figure 7-11. LoRA decomposes weight matrix W into product of two smaller matrices](../assets/ch07/fig-7-11-lora-decomposition.png){ width="700" }

<p class="figure-caption">Figure 7-11. LoRA decomposes weight matrix W into product of two smaller matrices</p>
...
![Figure 7-12. Keeping LoRA adapters separate allows reuse of the same full-rank matrix](../assets/ch07/fig-7-12-lora-adapters-reuse.png){ width="700" }

<p class="figure-caption">Figure 7-12. Keeping LoRA adapters separate allows reuse of the same full-rank matrix</p>
...
![Figure 7-6. Different floating point formats with range and precision](../assets/ch07/fig-7-6-floating-point-formats.png){ width="700" }

<p class="figure-caption">Figure 7-6. Different floating point formats with range and precision</p>
...
![Figure 7-15. How to linearly combine two layers](../assets/ch07/fig-7-15-linear-layer-combination.png){ width="700" }

<p class="figure-caption">Figure 7-15. How to linearly combine two layers</p>
...
![Figure 7-17. Keeping top 20 percent of task vector achieves best results](../assets/ch07/fig-7-17-task-vector-pruning.png){ width="700" }

<p class="figure-caption">Figure 7-17. Keeping top 20 percent of task vector achieves best results</p>
...
![Figure 7-20. Merging two LoRA adapters using concatenation](../assets/ch07/fig-7-20-lora-adapter-concatenation.png){ width="700" }

<p class="figure-caption">Figure 7-20. Merging two LoRA adapters using concatenation</p>
...
![Figure 7-13. How ensembling and model merging work](../assets/ch07/fig-7-13-ensembling-vs-merging.png){ width="700" }

<p class="figure-caption">Figure 7-13. How ensembling and model merging work</p>
...
![Figure 7-3. Example application development flows](../assets/ch07/fig-7-3-development-flows.png){ width="700" }

<p class="figure-caption">Figure 7-3. Example application development flows</p>
