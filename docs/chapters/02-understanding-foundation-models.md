...
![Figure 2-1. On the MMLU benchmark, GPT-4 performs better in English than in any other language](../assets/ch02/fig-2-1-gpt4-mmlu-across-languages.png){ width="700" }

<p class="figure-caption">Figure 2-1. On the MMLU benchmark, GPT-4 performs better in English than in any other language</p>


![Figure 2-2. GPT-4 is much better at math in English than in other languages](../assets/ch02/fig-2-2-gpt4-math-across-languages.png){ width="700" }

<p class="figure-caption">Figure 2-2. GPT-4 is much better at math in English than in other languages</p>
...
![Figure 2-3. Distribution of domains in the C4 dataset](../assets/ch02/fig-2-3-c4-dataset-domains.png){ width="700" }

<p class="figure-caption">Figure 2-3. Distribution of domains in the C4 dataset</p>
...
![Figure 2-6. Transformer model architecture](../assets/ch02/fig-2-6-transformer-architecture.png){ width="700" }

<p class="figure-caption">Figure 2-6. Transformer model architecture</p>
...
![Figure 2-5. An example of the attention mechanism in action](../assets/ch02/fig-2-5-attention-mechanism.png){ width="700" }

<p class="figure-caption">Figure 2-5. An example of the attention mechanism in action</p>
...
![Figure 2-7. Transformer, Mamba, and Jamba blocks](../assets/ch02/fig-2-7-transformer-mamba-jamba.png){ width="700" }

<p class="figure-caption">Figure 2-7. Transformer, Mamba, and Jamba blocks</p>
...
![Figure 2-8. Scaling laws for predicting optimal parameters and training data](../assets/ch02/fig-2-8-scaling-laws.png){ width="700" }

<p class="figure-caption">Figure 2-8. Scaling laws for predicting optimal parameters and training data</p>
...
![Figure 2-10. The overall training workflow with pre-training, SFT, and RLHF](../assets/ch02/fig-2-10-training-workflow.png){ width="700" }

<p class="figure-caption">Figure 2-10. The overall training workflow with pre-training, SFT, and RLHF</p>
...
![Figure 2-12. Distribution of prompts used to finetune InstructGPT](../assets/ch02/fig-2-12-instructgpt-prompt-distribution.png){ width="700" }

<p class="figure-caption">Figure 2-12. Distribution of prompts used to finetune InstructGPT</p>
...
![Figure 2-13. OpenAI labeler UI for creating comparison data](../assets/ch02/fig-2-13-openai-labeler-ui.png){ width="700" }

<p class="figure-caption">Figure 2-13. OpenAI labeler UI for creating comparison data</p>
...
![Figure 2-14. To generate the next token, the language model computes probability distribution](../assets/ch02/fig-2-14-next-token-probability.png){ width="700" }

<p class="figure-caption">Figure 2-14. To generate the next token, the language model computes probability distribution</p>
...
![Figure 2-16. Softmax probabilities at different temperatures](../assets/ch02/fig-2-16-softmax-temperature.png){ width="700" }

<p class="figure-caption">Figure 2-16. Softmax probabilities at different temperatures</p>
...
![Figure 2-17. How logits, probabilities, and logprobs are computed](../assets/ch02/fig-2-17-logits-probabilities-logprobs.png){ width="700" }

<p class="figure-caption">Figure 2-17. How logits, probabilities, and logprobs are computed</p>
...
![Figure 2-19. Sampling more outputs led to better performance](../assets/ch02/fig-2-19-sampling-more-outputs.png){ width="700" }

<p class="figure-caption">Figure 2-19. Sampling more outputs led to better performance</p>
...
![Figure 2-20. Using guidance to generate constrained outputs](../assets/ch02/fig-2-20-guided-constrained-outputs.png){ width="700" }

<p class="figure-caption">Figure 2-20. Using guidance to generate constrained outputs</p>


![Figure 2-22. Adding a classifier head to your base model](../assets/ch02/fig-2-22-classifier-head.png){ width="700" }

<p class="figure-caption">Figure 2-22. Adding a classifier head to your base model</p>
...
![Figure 2-24. An example of self-delusion by LLaVA-v1.5-7B](../assets/ch02/fig-2-24-llava-self-delusion.png){ width="700" }

<p class="figure-caption">Figure 2-24. An example of self-delusion by LLaVA-v1.5-7B</p>
...
![Figure 2-26. Hallucination is worse for the model that uses both RLHF and SFT](../assets/ch02/fig-2-26-hallucination-rlhf-sft.png){ width="700" }

<p class="figure-caption">Figure 2-26. Hallucination is worse for the model that uses both RLHF and SFT</p>
