...
![Figure 6-1. The retrieve-then-generate pattern](../assets/ch06/fig-6-1-retrieve-then-generate.png){ width="700" }

<p class="figure-caption">Figure 6-1. The retrieve-then-generate pattern</p>
...
![Figure 6-2. A basic RAG architecture](../assets/ch06/fig-6-2-basic-rag-architecture.png){ width="700" }

<p class="figure-caption">Figure 6-2. A basic RAG architecture</p>
...
![Figure 6-3. How an embedding-based semantic retriever works](../assets/ch06/fig-6-3-embedding-retriever.png){ width="700" }

<p class="figure-caption">Figure 6-3. How an embedding-based semantic retriever works</p>
...
![Figure 6-5. Anthropic augments chunks with context for situational retrieval](../assets/ch06/fig-6-5-contextual-retrieval.png){ width="700" }

<p class="figure-caption">Figure 6-5. Anthropic augments chunks with context for situational retrieval</p>
...
![Figure 6-4. Using generative models to rewrite queries](../assets/ch06/fig-6-4-query-rewriting.png){ width="700" }

<p class="figure-caption">Figure 6-4. Using generative models to rewrite queries</p>
...
![Figure 6-6. Multimodal RAG augments query with text and images](../assets/ch06/fig-6-6-multimodal-rag.png){ width="700" }

<p class="figure-caption">Figure 6-6. Multimodal RAG augments query with text and images</p>
...
![Figure 6-8. SWE-agent coding agent visualization](../assets/ch06/fig-6-8-swe-agent.png){ width="700" }

<p class="figure-caption">Figure 6-8. SWE-agent coding agent visualization</p>
...
![Figure 6-14. Different models express different tool use patterns](../assets/ch06/fig-6-14-tool-use-models.png){ width="700" }

<p class="figure-caption">Figure 6-14. Different models express different tool use patterns</p>
...
![Figure 6-15. Tool transition tree](../assets/ch06/fig-6-15-tool-transition-tree.png){ width="700" }

<p class="figure-caption">Figure 6-15. Tool transition tree</p>
...
![Figure 6-9. Decoupling planning and execution](../assets/ch06/fig-6-9-planning-execution.png){ width="700" }

<p class="figure-caption">Figure 6-9. Decoupling planning and execution</p>
...
![Figure 6-12. Agent following the ReAct framework](../assets/ch06/fig-6-12-react-framework.png){ width="700" }

<p class="figure-caption">Figure 6-12. Agent following the ReAct framework</p>
