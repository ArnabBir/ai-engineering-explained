...
![Figure 9-1. A simple inference service](../assets/ch09/fig-9-1-simple-inference-service.png){ width="700" }

<p class="figure-caption">Figure 9-1. A simple inference service</p>
...
![Figure 9-3. Prefilling and decoding phases](../assets/ch09/fig-9-3-prefilling-and-decoding.png){ width="700" }

<p class="figure-caption">Figure 9-3. Prefilling and decoding phases</p>
...
![Figure 9-2. Roofline chart for analyzing compute vs memory bottlenecks](../assets/ch09/fig-9-2-roofline-chart.png){ width="700" }

<p class="figure-caption">Figure 9-2. Roofline chart for analyzing compute vs memory bottlenecks</p>
...
![Figure 9-6. Different compute primitives](../assets/ch09/fig-9-6-compute-primitives.png){ width="700" }

<p class="figure-caption">Figure 9-6. Different compute primitives</p>
...
![Figure 9-5. Bandwidth utilization for Llama 2-70B across different chips](../assets/ch09/fig-9-5-bandwidth-utilization.png){ width="700" }

<p class="figure-caption">Figure 9-5. Bandwidth utilization for Llama 2-70B across different chips</p>
...
![Figure 9-8. Inference optimization techniques overview](../assets/ch09/fig-9-8-inference-optimization-techniques.png){ width="700" }

<p class="figure-caption">Figure 9-8. Inference optimization techniques overview</p>
...
![Figure 9-14. Throughput improvement by different optimization techniques](../assets/ch09/fig-9-14-throughput-improvement.png){ width="700" }

<p class="figure-caption">Figure 9-14. Throughput improvement by different optimization techniques</p>
...
![Figure 9-15. Dynamic batching keeps latency manageable](../assets/ch09/fig-9-15-dynamic-batching.png){ width="700" }

<p class="figure-caption">Figure 9-15. Dynamic batching keeps latency manageable</p>
...
![Figure 9-17. Prompt cache for overlapping segments](../assets/ch09/fig-9-17-prompt-cache.png){ width="700" }

<p class="figure-caption">Figure 9-17. Prompt cache for overlapping segments</p>
...
![Figure 9-19. Pipeline parallelism enables model splits to execute in parallel](../assets/ch09/fig-9-19-pipeline-parallelism.png){ width="700" }

<p class="figure-caption">Figure 9-19. Pipeline parallelism enables model splits to execute in parallel</p>
