...
![Figure 3-1. The trend of LLM evaluation papers over time](../assets/ch03/fig-3-1-llm-evaluation-papers-trend.png){ width="700" }

<p class="figure-caption">Figure 3-1. The trend of LLM evaluation papers over time</p>
...
![Figure 3-7. Evaluation framework overview](../assets/ch03/fig-3-7-evaluation-framework.png){ width="700" }

<p class="figure-caption">Figure 3-7. Evaluation framework overview</p>
...
![Figure 3-5. An image-captioning task example where Fuyu generated a caption for Big Ben](../assets/ch03/fig-3-5-image-captioning-example.png){ width="700" }

<p class="figure-caption">Figure 3-5. An image-captioning task example where Fuyu generated a caption for Big Ben</p>
...
![Figure 3-6. CLIP architecture trained using image text pairs](../assets/ch03/fig-3-6-clip-architecture.png){ width="700" }

<p class="figure-caption">Figure 3-6. CLIP architecture trained using image text pairs</p>
...
![Figure 3-8. An example of an AI judge evaluating answer quality](../assets/ch03/fig-3-8-ai-judge-example.png){ width="700" }

<p class="figure-caption">Figure 3-8. An example of an AI judge evaluating answer quality</p>
...
![Figure 3-9. How PandaLM works for model comparison](../assets/ch03/fig-3-9-pandalm-example.png){ width="700" }

<p class="figure-caption">Figure 3-9. How PandaLM works for model comparison</p>
...
![Figure 3-10. ChatGPT asks users to compare two outputs side by side](../assets/ch03/fig-3-10-chatgpt-side-by-side.png){ width="700" }

<p class="figure-caption">Figure 3-10. ChatGPT asks users to compare two outputs side by side</p>
