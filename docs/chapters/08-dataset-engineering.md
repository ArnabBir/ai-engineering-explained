...
![Figure 8-1. Dataset engineering overview](../assets/ch08/fig-8-1-dataset-engineering-overview.png){ width="700" }

<p class="figure-caption">Figure 8-1. Dataset engineering overview</p>
...
![Figure 8-3. Performance gain curve with different dataset sizes](../assets/ch08/fig-8-3-performance-gain-curve.png){ width="700" }

<p class="figure-caption">Figure 8-3. Performance gain curve with different dataset sizes</p>
...
![Figure 8-5. A seed task and generated task used to train Alpaca](../assets/ch08/fig-8-5-alpaca-seed-task.png){ width="700" }

<p class="figure-caption">Figure 8-5. A seed task and generated task used to train Alpaca</p>
...
![Figure 8-7. Distribution of response length for GPT-4 and GPT-3](../assets/ch08/fig-8-7-gpt4-vs-gpt3-response-length.png){ width="700" }

<p class="figure-caption">Figure 8-7. Distribution of response length for GPT-4 and GPT-3</p>
